...
cover_text = [Paragraph("PRESS &amp; MEDIA", small), Paragraph("Byte by Byte<br/><font color='#00E676'>Media Kit</font>", title), Paragraph("Official biographies, photography, project background, guest highlights, and contact information for reporters, educators, and organizations.", body), Spacer(1, 12), Paragraph("VIHAAN MATHUR<br/>Creator and Host", small)]
...
"Today, Vihaan continues developing his technical knowledge, communication skills, and network of mentors through the Center for Information Technology and Byte by Byte. He hopes the project encourages other students to stay curious, ask informed questions, and see themselves as participants in the future of technology."
]
